...
//#define Z_BUFSIZE	 4096//압축하고 푸는데 너무 오래걸린다.
//#define Z_BUFSIZE	 65536
#define Z_BUFSIZE	 262144
//#define Z_BUFSIZE	 524288
...
template< int t_nBufferLength = 1024 ,int t_nLevel=Z_BEST_SPEED,int t_nStrategy=Z_DEFAULT_STRATEGY>
