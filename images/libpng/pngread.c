...
png_read_info(png_structrp png_ptr, png_inforp info_ptr)
{
   ...
   if (png_ptr == NULL || info_ptr == NULL)
      return;
//fprintf(stderr,"\n pngread.c - png_read_info 1");
   /* Read and check the PNG file signature. */
   png_read_sig(png_ptr, info_ptr);
//fprintf(stderr,"\n pngread.c - png_read_info 2");

   for (;;)
   {
//fprintf(stderr,"\n pngread.c - png_read_info 3");
      png_uint_32 length = png_read_chunk_header(png_ptr);
      png_uint_32 chunk_name = png_ptr->chunk_name;
//fprintf(stderr,"\n pngread.c - png_read_info 4");
      /* IDAT logic needs to happen here to simplify getting the two flags
       * right.
       */
      if (chunk_name == png_IDAT)
      {
//fprintf(stderr,"\n pngread.c - png_read_info 5");		  
...
//fprintf(stderr,"\n pngread.c - png_read_info 6");		  
       ...
       */
      if (chunk_name == png_IHDR) { // 이쪽이 실행된다.
//fprintf(stderr,"\n pngread.c - png_read_info 7");		  
         png_handle_IHDR(png_ptr, info_ptr, length);
	  }

      else if (chunk_name == png_IEND){
//fprintf(stderr,"\n pngread.c - png_read_info 8");		  
...
//fprintf(stderr,"\n pngread.c - png_read_info 10");		  
         png_handle_PLTE(png_ptr, info_ptr, length);
	  }

      else if (chunk_name == png_IDAT)
      {
//fprintf(stderr,"\n pngread.c - png_read_info 11");		  
...
//fprintf(stderr,"\n pngread.c - png_read_row 7");
   ...
   png_read_finish_row(png_ptr);
//fprintf(stderr,"\n pngread.c - png_read_row 8");

   if (png_ptr->read_row_fn != NULL)
      (*(png_ptr->read_row_fn))(png_ptr, png_ptr->row_number, png_ptr->pass);

  //fprintf(stderr,"\n pngread.c - png_read_row end");
...
{
//fprintf(stderr,"\n pngread.c - png_read_image start");	
...
//fprintf(stderr,"\n pngread.c - png_read_image 1 , image_height %d,pass %d",image_height,pass);	
   for (j = 0; j < pass; j++)
   {
      rp = image;
